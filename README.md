...
- 서브햄찌 강화, 철거 효과음 추가
- 서브햄찌 강화시 씨앗이 부족하면 안내 메시지 출력
- 광고제거 상품을 구매한 후에도 다시 구매가 가능하던 버그 수정
- 전투씬에서 각 스킬별로 강화를 몇번이나 했는지 표시하는 UI 추가
- 서브햄찌의 공격 쿨타임, 강화레벨 UI 추가
- 서브햄찌 관련 안내문구가 사라지지 않던 버그 수정
- 몬스터HP바 버그 수정
- 보스몬스터 능력치 업데이트
---
## V.3.1.11 JS 2024-02-13
- 도감
  - "카드스킬"을 "선택스킬"로 수정 완료
  - 마력구 포함 및 설명 추가
  - 도감_몬스터 구현 완료
...
- UI
  - Card UI Qual Up
    ...
    - Upgrade description 은 폰트 24 (기획 수진 요청사항) / 나머지는 20
...
---
## V.3.1.9 SM 2024-02-12
- 봄바르다 데미지가 종종 안들어가던 버그 수정
- 쳇바퀴 충전 로직 실패
- 레벨업시 어떻게 능력치가 변화하는지 표시
<p align="center">
<img src = "https://github.com/Jinlee0206/EvenIGamethon/assets/109404269/15eb12a4-a96b-4615-a239-57377e1df1ce" width = "180" height = "360">
</p>

- 현재 레벨에서 얼마나 능력치가 올랐는지 표시
<p align="center">
...
- 서버 버그 전부 수정
	- 게임 진행 후 로비로 돌아왔을 때 데이터가 이상해지는 버그
	- 쳇바퀴가 소모되지 않는 버그
- 로비 햄스터 모션 수정
- 오프닝 컷씬 이미지 수정
- 밸런스 V8 적용
---
## V.3.1.4 - SM 2024-02-07
- Balance_V7 적용
- 서브햄찌 철거 후 설치시 이전 서브햄찌의 쿨타임이 그대로 적용되던 버그 수정
- 레벨업 옥수수 소모 만들어라
	- 버그 수정
		- 옥수수, 빵 관련 필터링 버그 수정
		- 소모되지 않던 버그 수정
...
- 보상 UI 수정
<p align="center">
<img src = "https://github.com/Jinlee0206/EvenIGamethon/assets/109404269/9a56f75f-9960-44e8-ac89-8dfade488c3a" width = "180" height = "360">
</p>
